...
if __name__ == "__main__":
    ...
    cross_entropy = tf.reduce_mean(-tf.reduce_sum(y * tf.math.log(yhat), reduction_indices=[1]))

    optimiser = tf.keras.optimizers.SGD(learning_rate=learning_rate).minimize(cross_entropy, yhat)
