...
def generate_recommendation(movie_matrix: pd.DataFrame, movie_title: str, year: str) -> pd.DataFrame:
...
if __name__ == '__main__':
    ...
    movie_matrix = data_set.pivot_table(index='userId', columns='title', values='rating')
    ...
    corr_10_best = corr[df_ratings['number_of_ratings'] > 100].sort_values(by='correlation', ascending=False).head(10)
    print(corr_10_best)
