...
def gradient_ascent(x, iterations, step, max_loss=None):
    for i in range(iterations):
        loss_value, grad_value = eval_loos_and_grads(x)
...
# modify this parameters for different visual effect
step = 0.01
num_octave = 3
octave_scale = 1.4
iterations = 20
...
base_image_path = "ja.png"
img = prepossess_image(base_image_path)
